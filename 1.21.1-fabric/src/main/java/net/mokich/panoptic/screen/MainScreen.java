...
public class MainScreen extends Screen {
    ...
    protected void init() {
        ...
        kpi("panoptic.dash.mods", () -> FabricLoader.getInstance().getAllMods().size());
        kpi("panoptic.dash.items", () -> BuiltInRegistries.ITEM.keySet().size());
        kpi("panoptic.dash.blocks", () -> BuiltInRegistries.BLOCK.keySet().size());
        kpi("panoptic.dash.entities", () -> BuiltInRegistries.ENTITY_TYPE.keySet().size());
        ...
        kpi("panoptic.dash.advancements", () -> {
            ...
            return mc.player.connection.getAdvancements().getTree().nodes().size();
        });
    }
