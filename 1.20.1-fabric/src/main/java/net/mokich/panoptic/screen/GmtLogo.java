...
public final class GmtLogo {
    ...
    public static final ResourceLocation CORE_TEX =
            new ResourceLocation("panoptic", "textures/gui/logo_core.png");

    private static final ResourceLocation[] RING_TEX = {
            new ResourceLocation("panoptic", "textures/gui/logo_ring0.png"),
            new ResourceLocation("panoptic", "textures/gui/logo_ring1.png"),
            new ResourceLocation("panoptic", "textures/gui/logo_ring2.png")
    };
