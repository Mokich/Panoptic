...
public final class GrabReplay {
                        ...
                        case "e" -> {
                            ...
                            if (ent != null) {
                                InventoryScreen.renderEntityInInventoryFollowsMouse(
                                        g, (int) o.x1, (int) o.y1, Math.max(1, (int) o.scale), o.minU, o.minV, ent);
                            }
                        }
                        default -> {
                        }
    ...
    public static void blitUV(GuiGraphics g, ResourceLocation tex, float x1, float y1, float x2, float y2,
        ...
        buf.vertex(mat, x1, y1, 0.0F).uv(u1, v1).endVertex();
        buf.vertex(mat, x1, y2, 0.0F).uv(u1, v2).endVertex();
        buf.vertex(mat, x2, y2, 0.0F).uv(u2, v2).endVertex();
        buf.vertex(mat, x2, y1, 0.0F).uv(u2, v1).endVertex();
