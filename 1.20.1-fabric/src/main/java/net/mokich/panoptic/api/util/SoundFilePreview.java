...
public final class SoundFilePreview extends AbstractSoundInstance {
    ...
    public WeighedSoundEvents resolve(SoundManager manager) {
        this.sound = new Sound(this.location.toString(), ConstantFloat.of(1.0F), ConstantFloat.of(1.0F),
    ...
    public static boolean play(String resourcePath) {
        ...
        try {
            ...
            pausedElapsed = 0L;
            pendingSeekMs = -1L;
            durationMs = oggDurationMs(new ResourceLocation(ns, "sounds/" + name + ".ogg"));
            return true;
        } catch (Throwable t) {
            return false;
        }
