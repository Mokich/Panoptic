...
public class StructureResultPacket {
    public static final ResourceLocation CHANNEL = new ResourceLocation("panoptic", "structure_result");
    ...
    public static void send(ServerPlayer player, StructureResultPacket msg) {
    ...
    public static void handle(StructureResultPacket msg) {
        StructureClientHandler.handle(msg);
    }
